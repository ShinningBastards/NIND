...
external_url 'https://gitlab.nind.epitech.musubi.dev'
...
letsencrypt['contact_emails'] = ['raphaelthi59@gmail.com'] # This should be an array of email addresses to add as contacts
